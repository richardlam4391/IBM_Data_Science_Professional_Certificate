...
* **Languages:** Python (Pandas, NumPy, Requests)
* **Data Collection & Wrangling:** Beautiful Soup (Web Scraping), REST APIs (SpaceX API)
* **Exploratory Data Analysis (EDA):** SQL (SQLite / IBM Db2), Seaborn, Matplotlib
* **Interactive Visualizations:** Folium (Geospatial maps), Plotly Dash (Interactive Dashboards)
